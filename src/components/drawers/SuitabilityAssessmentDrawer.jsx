                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-xs">
                    ...
                    <div className="space-y-1">
                      ...
                      <select className="w-full bg-white border border-zinc-200 rounded-lg p-2 font-bold text-zinc-800 focus:ring-2 focus:ring-[#E6308A]/20 focus:border-[#E6308A]">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-[#0A0A0A] rounded-xl p-4 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10 space-y-3">
                      <h4 className="text-xs font-bold text-[#C6E84F] uppercase flex items-center gap-2">
                      ...
                      <div className="flex gap-4 pt-2 border-t border-zinc-800">
                        ...
                        <div>
                          ...
                          <span className="text-sm font-bold text-[#E6308A] mt-1 block">Level 3</span>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="flex gap-2">
            ...
            {step < 8 ? (
              ...
              <button 
                ...
                className="px-5 py-2 text-xs font-bold text-black bg-[#C6E84F] hover:opacity-90 rounded-lg transition-colors shadow-sm uppercase tracking-wider"
              >
                Submit to Checker
              </button>
            )}
